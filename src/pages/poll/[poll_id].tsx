...
const IndividualPoll = ({ poll, total_votes }: IndividualPollInterface) => {
  ...
  const onVoteRegistered = (id: string) => {
    ...
    const loader = toast.loading('Submitting your vote!');
    axios({
      url: '/api/v1/votes',
      method: 'POST',
      data: {
      ...
      .then((d) => {
        ...
        if (d.status == 202) {
          return toast.success('You already voted for this poll!', {
            id: loader,
          });
        }
        toast.success('Vote registered!', { id: loader });
        fireConfetti();
      })
      .catch(() => toast.error('Something went wrong!', { id: loader }));
  };
              ...
              return (
                ...
                >
                  <div
                    ...
                    className="absolute top-0 left-0 -z-10 h-full w-full rounded-md bg-indigo-200 transition-all duration-1000"
                  ></div>
